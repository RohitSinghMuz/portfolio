...
const Testimonial=()=>{
  return (
    <section className="testimonial--section" id="testimonial">
      <Box className="portfolio--container-box">
        <Box className="portfolio--container">
          <Typography className="sections--heading">Customer Feedback</Typography>
        </Box>
      </Box>
      <Box className="portfolio--section--container">
        {data?.testimonial?.map((item, index) => (
          <Box key={index} className="testimonial--section--card">
            <Box className="testimonial--section--card--review">
            ...
            <Typography className="text-md">{item.description}</Typography>
            <Box className="testimonial--section--card--author--detail">
              <img src={item.src} alt="Avatar" style={{width:"120px",height:'80px',borderRadius:'20px'}}/>
              <Box>
                <Typography className="text-md testimonial--author--name">
                  {item.author_name}
                </Typography>
                <Typography className="text-md testimonial--author--designation">
